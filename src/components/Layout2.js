          ...
          <div className="h-full px-4 flex justify-between items-center space-x-4">
            <Link href="/" className="flex items-center space-x-1">
              ...
              <span className="text-xl font-semibold tracking-wide">
                LoL<span className="text-red-600">Fan</span>
              </span>
            ...
            <div className="flex items-center space-x-4">
              ...
              {isLoadingUser ? (
                ...
                <button
                  type="button"
                  onClick={openModal}
                  className="ml-4 px-4 py-1 rounded-md bg-red-600 hover:bg-red-500 focus:outline-none focus:ring-4 focus:ring-red-500 focus:ring-opacity-50 text-white transition"
                >
                  Log in
                </button>
              )}
